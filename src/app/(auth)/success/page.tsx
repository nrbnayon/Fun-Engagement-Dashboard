...
export default function CongratulationsPage() {
  return (
    <div className="min-h-screen bg-card font-oswald flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <div className="relative w-32 h-32 bg-white/80 rounded-full shadow-2xl shadow-gray-300/60 flex items-center justify-center">
              ...
              <div className="w-20 h-20 bg-[#001d38] rounded-full flex items-center justify-center shadow-inner">
        ...
        {/* Description Text */}
        <p className="text-muted text-base leading-relaxed mb-8 px-4">
