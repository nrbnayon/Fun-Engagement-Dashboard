...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <header className="flex w-full items-center justify-between px-6 py-[18px] bg-primary-light dark:bg-surface border-b border-border transition-colors duration-200">
      {/* Greeting Section */}
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          {/* <BellIcon className="h-5 w-5 text-text-secondary dark:text-text-secondary" /> */}
