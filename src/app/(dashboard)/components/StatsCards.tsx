    ...
    <main className="flex flex-col w-full items-center">
      <div className="flex items-stretch gap-5 w-full">
        {statsData.map((card, index) => (
          <Card
            key={index}
            className="flex flex-col w-44 h-40 items-center justify-between gap-3 p-3 bg-surface border-border dark:bg-surface"
          >
        ...
        {matchCards.map((match, index) => (
          <Card
            key={index}
            className="flex flex-col w-96 h-40 items-start justify-between gap-6 px-6 py-4 border-border bg-card dark:bg-surface"
          >
